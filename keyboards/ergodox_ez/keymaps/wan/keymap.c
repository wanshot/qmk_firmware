 ...
 * |--------+------+------+------+------+------| EISU |           | KANA |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |  /   |]}/Shift|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[BASE] = KEYMAP(  // layer 0 : default
        // left hand
        KC_EXLM,        KC_1,              KC_2,           KC_3,   KC_4,   KC_5,   KC_6,
        KC_TAB,         KC_Q,              KC_W,           KC_E,   KC_R,   KC_T,   KC_QUOT,
        CTL_T(KC_ESC),  KC_A,              KC_S,           KC_D,   KC_F,   KC_G,
        KC_LSFT,        CTL_T(KC_Z),       KC_X,           KC_C,   KC_V,   KC_B,   ALL_T(KC_LANG2),
        KC_AT,          LT(SYMB,KC_GRV),   LALT(KC_LSFT),  KC_BSLS,KC_GRV,
                                           KC_LGUI,        KC_END,
                                                                   KC_HOME,
                                           KC_SPC,         KC_BSPC,KC_LGUI,
        // right hand
             KC_7,           KC_8,   KC_9,    KC_0,    KC_LPRN, KC_RPRN,          KC_EQL,
             KC_TILD,        KC_Y,   KC_U,    KC_I,    KC_O,    KC_P,             KC_MINS,
                             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN,          KC_LBRC,
             MEH_T(KC_LANG1),KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          SFT_T(KC_RBRC),
                                  	 KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,         KC_FN1,
             KC_LALT,        CTL_T(KC_ESC),
             KC_PGUP,
             KC_PGDN,LT(MDIA, KC_ESC), LT(SYMB,KC_ENT)
    ),
